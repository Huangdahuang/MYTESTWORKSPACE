...
<body>
	...
	<div style="margin: 15px auto; ">
		...
		<s:form action="TopicAction_list" namespace="/" theme="simple"
			...
			<font class="logoLabel">大黄的贴吧</font>
	...
	<table cellspacing="0">
		<tbody class="list topicList">
			...
			<tr>
				<td colspan="5" class="num"><s:property value="#list.size"/><font color="red"></font>个</td>
			</tr>
		</tbody>
	</table>
	...
	<s:form action="TopicAction_add" namespace="/" theme="simple">
		<table class="publishArticleForm">
			...
			<tr>
				<td>内 容:</td>
				<td><s:textarea name="topic.topicContent" cssClass="content">
					</s:textarea>
				</td>
			</tr>
			<tr>
