...
<script type="text/javascript">
	...
	function delAllBooks() {
		...
		location.href = "${pageContext.request.contextPath}/servlet/delAllBookServlet?"+str;
	}
</script>
</HEAD>
<body>
				...
				<tr>
					<td class="ta_01" align="right">
						<button type="button" id="add" name="add" value="批量删除"
							class="button_add" onclick="delAllBooks()">批量删除</button>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="12%"><input type="checkbox"
									id="ckAll" onclick="checkAll()" />全选/全不选</td>
							...
							<c:forEach items="${books }" var="b">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23"><input type="checkbox" name="ids"
										value="${b.id }" /></td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="23">${b.id }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="8%">${b.pnum }</td>
									<td style="CURSOR: hand; HEIGHT: 22px" align="center">${b.category
										}</td>
									...
									<td align="center" style="HEIGHT: 22px" width="7%"><a
										href="javascript:delBook('${b.id }')"> <img
