			...
			xhr.onreadystatechange = function(){
				if(xhr.readyState==4){//请求一 切正常
					if(xhr.status==200){//服务器响应一切正常
						var ss = eval(xhr.responseText); // 把["1001","1002","1003"]成数组
						var childDivs = "";
						//循环把数据放入小的div中
...
<div id="divsearch">
	...
	<div id="context1" style="display:block;border:1px solid red;background-color:white; width:128px;position:absolute;left:940px;top:135px;">
